...
class Room_Service_Img_Dynamic_Tag extends \Elementor\Core\DynamicTags\Data_Tag {

    public function get_name() {
        return 'room-service-img';
    }

    public function get_title() {
        return __( 'Room Service Image', 'text-domain' );
    }
    ...
    public function get_value( array $options = [] ) {
        ...
        if (!empty($term_names) && $start_index < count($term_names)) {
            ...
            $term = get_term_by('name', $term_name, 'room-service');
...
\Elementor\Plugin::instance()->dynamic_tags->register(new Room_Service_Img_Dynamic_Tag());
